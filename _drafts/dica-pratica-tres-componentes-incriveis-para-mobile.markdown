...
E como esse texto é inserido com CSS, pode ser facilmente alterado com o uso de <a href="http://www.w3schools.com/cssref/css3_pr_mediaquery.asp">Media Query</a>.

Então podemos usar esse nosso exemplo para mostrar apenas partes do nome em telas menores:
...
Esse código diz que a parte "Novaes" só será mostrada para telas maiores que tamanho média (medium), e "Dayman" apenas para telas maiores que tamanho pequeno (small).
...
Eu uso essa técnica no meu site pessoal, na seção de habilidade, onde mostra várias tecnologias com o nome a uma foto. O nome é incluído desta forma, sendo que em dispositivos mobiles, o texto some e ficam apenas as imagens.

<span class="center-horizontal">
  <img src="/blog/src/img/2016-01-30-gif-skills.gif" alt="habilidades responsivas">
</span>

<h2>2. Modularização inteligente com o Sass</h2>

Modularização não é exatamente
